...
compareDirectory = r'C:\Users\Ricardo\OneDrive\Desktop\repos\FacialRecogAttendance\PhotosTaken'
    ...
    for people in os.listdir(compareDirectory):
        ...
        for student in os.listdir(mainDirectory): 
            ...
            for img in os.listdir(newPath):
                ...
                #compares the encoded faces and returns a true or false variable in a list depending on if the image matches
                result = fr.compare_faces([comparedImage_encoded], takenImage_encoded)
