...
def comapareFace():
    ...
    for people in os.listdir(compareDirectory):
        ...
        determinePresence(confidence, name,peoplePresent=peoplePresent,totalConfidence=totalConfidence)  
...
"""  
def determinePresence(confidence, name, peoplePresent, totalConfidence):
    i = 0
